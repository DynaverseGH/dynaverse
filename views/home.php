...
<!-- Mirrored from Dynaverse.net/ by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Aug 2023 22:57:34 GMT -->
...
<meta name="page_url" content="Dynaverse.net/">
...
<meta name="facebook-domain-verification" content="d29bvi52iy99e55ujwls1cxxwob14c" />
    ...
    <title id="Dynaverse">Pakistan's Leading Digital Technology Providing Company </title>
    <meta name="description" content="As one of the leading IT companies in Pakistan, we help organizations define compelling digital strategies and design powerful brand experiences." />
    <meta name="keywords" content="Pakistan leading it company, it companies in Pakistan">
    <link rel="icon" href="../assets/logo/neww.png" GI sizes="16x16">
    
</head>

<body data-rsssl=1 class="hold home before">
    ...
    <div id="wrapper">
        ...
        <div id="container">
            <main id="content">
            <div class="logo">
            <h1> <a class="tilt-in-top-1" href="index/" title="Dynaverse" rel="home"> <span class="ghost">Dynaverse</span>
            <img width="250px"   class="footer-logo img" src="./assets/logo/DV.png" alt="">
            <!-- <svg class="footer-logo img" width="170" height="40" viewBox="0 0 148 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                 ...
                 <?php include("./includes/video.php");?>
                    <h5 data-theme="light" class="caption tiny-b primary ">&nbsp;</h5>
                    <!-- <div class="mirrors" id="mirrors"></div> -->
                    <div style=" color: #fff; " class="left first wide craft">
                    <div>
                    <!-- <div class="dark-fire">
        <h1 class="Blazing" contenteditable="true">Dynaverse</h1>
  </div> -->
            <h3 class="flicker">Going above <br>  and  beyond is what we do</h3>
        </div>
           <img   class="image" width="300px" height="100px" src="./assets/logo/neww.png" alt=""> 
            <!-- <img   class="image2" width="300px" height="100px" src="./assets/logo/neww.png" alt="">  -->
    </div>
    <!-- <img   class="image" width="300px" height="100px" src="./assets/logo/neww.png" alt=""> -->
                    <!-- <h2 style="font-size: 45px; width: 600px; height: 260px; line-height:normal; position: absolute; top:12rem; left: 5rem; " >Going above <br>  and  beyond is what we do</h2>
               
                        </h2> -->
                        
                       
                    
                    <div class="scrollTip tiny"> 
                         
                </div>
                </section>
                <section>
                    <h5 data-theme="dark" class="caption tiny-b primary ">&nbsp;</h5>
                    
                    <div class="left description off anim-text-box bg-dark">
                        <div class="indent"> <span class="tiny primary uppercase">We have Passion for our craft</span>
                            <p class="primary regular h2 ">With two decades of experience and a presence across the globe, our teams work as a cohesive unit to ensure we go above and beyond to deliver to our diverse customer base worldwide.</p>
                        </div> 
                        <a href="javascript:window.location.href='/contact/'" class="btn"><span>Learn More</span></a>

                    </div>
                </section>
                <section>
                    <h5 data-theme="dark" class="caption tiny-b primary hide">&nbsp;</h5>
                    
                    <div class="global">
                        <div class="left">
                            <!-- <img src="https://Dynaverse.net/assets/images/global.png" alt=""> -->
                            <h3 style="max-width: 490px;" class="primary bold h1">Tech Insights</h3>
                            <h3 style="max-width: 490px;" class="primary regular h3"> Take a dive into everything technology! Read about the latest technology problems, solutions and trends in the industry!</h3>

                            <a href="javascript:window.location.href='/insights/'" class="btn"><span>Learn More</span></a>
                        </div>
                        <div class="right">
                            <img src="assets/images/counter.png" alt="" loading="lazy" width="" height="">
                            
                        </div>
                    </div>
                </section>
                <section>
                    <h5 data-theme="light" class="caption tiny-b primary hide">&nbsp;</h5>
                    
                    <div class="global">
                    <div class="right">
                            <img src="assets/images/career.jpg" alt="" loading="lazy" width="" height="">
                            
                        </div>
                        <div class="left">
                            <!-- <img src="https://Dynaverse.net/assets/images/global.png" alt=""> -->
                            <h3 style="max-width: 490px;" class="primary bold h1">Careers</h3>
                            <h3 style="max-width: 490px;" class="primary regular h3"> Get yourself an exposure that is rewarding and fulfilling, offering a career trajectory that ends only at the top!</h3>
                ...
                <section>
                    ...
                    <div class="global">
                        ...
                        <div class="left">
                            <!-- <img src="https://Dynaverse.net/assets/images/global.png" alt=""> -->
                            <h3 style="max-width: 490px;" class="primary bold h1">Collaborate with Us</h3>
                            <h3 style="max-width: 490px;" class="primary regular h3"> Share your tech-related business ideas with us. We'll support you transform your dreams into reality!</h3>

                            <a href="javascript:window.location.href='/collaborate/'" class="btn"><span>Learn More</span></a>
                        </div>
                        <div class="right">
                            <img src="assets/images/collaborate.jpg" alt="" loading="lazy" width="" height="">
                ...
                <section>
                    ...
                    <div class="global">
                    <div class="right">
                            <img src="assets/images/incubation.jpg" alt="" loading="lazy" width="" height="">
                            
                        </div>
                        <div class="left">
                            <!-- <img src="https://Dynaverse.net/assets/images/global.png" alt=""> -->
                            <h3 style="max-width: 490px;" class="primary bold h1">Incubation Program</h3>
                            <h3 style="max-width: 490px;" class="primary regular h3"> A comprehensive training program that prepares our newly joined candidates for a successful journey by providing them relevant skills and training.</h3>
                ...
                <!-- <div class="reel__holder">
                    <div class="reel__inner"> <video id="player" data-type="reel" controls loop playsinline preload="none" src="https://Dynaverse.net/assets/video/Dynaverse-showreel-where-talent-reflects-art.mp4">>
                        </video> </div>
                    <div class="close-button-holder"> <a href="javascript:void(0);" onclick="javascript:Sals.closeReel(event);" class="close before after"><span class="ghost">Close</span></a> </div>
                </div> -->
            </main>
        </div>
...
<!-- Mirrored from Dynaverse.net/ by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Aug 2023 22:57:51 GMT -->
</php>