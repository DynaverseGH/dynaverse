...
<!-- Mirrored from Dynaverse.net/about-us/ by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Aug 2023 22:58:13 GMT -->
...
<meta name="page_url" content="Dynaverse.net/about-us/">
...
<meta name="facebook-domain-verification" content="d29bvi52iy99e55ujwls1cxxwob14c" />
    ...
    <title id="Dynaverse">IT Solutions | it solutions company | it companies in Pakistan</title>
    <meta name="description" content="By providing our clients with unparalleled IT solutions, we have made our mark as a dominant IT solutions company in Pakistan." />
    <meta name="keywords" content="it solutions company, it companies in Pakistan">
    <link rel="icon" href="../assets/images/favicon.ico" type="image/gif" sizes="16x16">
</head>

<body data-rsssl=1 class="projects inner before">
      ...
      <main id="content">
        <div class="logo">
          ...
          <div class="left first sect">
              <h2 class="h1 off anim-text ready mb-3 mb-md-5 extra"><span class="letter">About</span> <br><span class="letter border">Us.</span></h2>
              <img src="../assets/images/about/banner.jpg" alt="" class="img-full mb--2" loading="lazy" width="" height="">
          </div>
        </section>
        <section>
          <h5 data-theme="dark" class="caption d-none">&nbsp;</h5>
          <div class="left content sect">
            <h2 class="h2 off anim-text primary extra uppercase mb-4">GOING ABOVE AND BEYOND IS WHAT WE DO</h2>
            <p class="primary hero regular off anim-text mb-4 mb-md-5">With two decades of experience and a presence across the globe, our teams work as a cohesive unit to ensure we go above and beyond to deliver to our diverse customer base worldwide.</p>
            <div class="row-box pt-4 pt-md-5">
              <div class="row align-items-center">
                <div class="col-md-4">
                  <h3 class="h3 primary bold uppercase mb-4 mb-md-0">Innovation is our key principle and is fundamental to everything we do</h3>
                </div>
                <div class="col-md-8">
                  <p class="primary text mb-3">While providing a range of IT solutions and digital technology services to startups and large enterprises, alongside retailers and resellers, we empower our customers not only to grow, but to achieve excellence in everything they do.</p>
                  <p class="primary text">Explore the Dynaverse world and learn how we enable businesses worldwide in attaining their full potential.</p>
                </div>
              </div>
            </div>
          </div>
        </section>
        <section id="our-vision" class="">
          <h5 data-theme="dark" class="caption d-none">&nbsp;</h5>
          <div class="left sect cta ">
            <div class="row-box">
              <div class="row align-items-center">
                <div class="col-md-3 col-lg-2">
                <h3 class="h3 extra uppercase mb-4 mb-md-0">Our <br> vision</h3>
                </div>
                <div class="col-md-6 col-lg-4">
                  <p class="text ">A technologically connected world where no entity is left behind. We at Dynaverse empower businesses with innovative IT enabled services globally.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <section id="mission">
          <h5 data-theme="dark" class="caption d-none">&nbsp;</h5>
          <div class="left content sect t-over-wrap pb-5">
            <div class="row-box">
              <div class="row align-items-start">
                <div class="col-md-3 col-lg-2">
                <h3 class="h3 primary extra uppercase mb-4 mb-md-0">Our <br> mission</h3>
                </div>
                <div class="col-md-6 col-lg-5">
                  <p class="primary text ">Dynaverse Technologies is on a mission to build the best IT solutions and systems for businesses at every scale while creating a future where every technological advancement is for the benefit of the people.</p>
                </div>
                <div class="col-md-3 col-lg-5 mt-5 mt-md-0 ">
                  <img class="img-full t-over" src="../assets/images/about/banner2.jpg" alt="" loading="lazy" width="" height="">
                </div>
              </div>
            </div>
          </div>
        ...
        <section id="team">
          <h5 data-theme="dark" class="caption d-none">&nbsp;</h5>
          <div class="left content sect pb-0 pt-0 ">
            <h2 class="h2 off anim-text primary extra uppercase mb-4">Leadership</h2>
            <div class="slider team py-0">
              <div class="slider__viewport">
                <div class="slider__container cursor-drag">
                  <div class="slide">
                    <div class="slide__inner plane">
                      <figure class="img"> 
                        <img src="../../www.Dynaverse.net/assets/images/team/salman.png" alt="" loading="lazy" width="" height=""> 
                      </figure>
                    </div>
                    <div class="reference"> <a href="javascript:void(0);" data-url=""> <span class="name">Salman ghaznavi</span> <span class="h4">Founder & CEO</span> </a> </div>
                  </div>
                  <div class="slide">
                    <div class="slide__inner plane">
                      <figure class="img">
                        <img src="../../www.Dynaverse.net/assets/images/team/umair.png" alt="" loading="lazy" width="" height=""> 
                      </figure>
                    </div>
                    <div class="reference"> <a href="javascript:void(0);" data-url=""> <span class="name">Omair Ahmed Siddiqui</span> <span class="h4">President</span> </a> </div>
                  </div>
             <!--      <div class="slide">
                    <div class="slide__inner plane">
                      <figure class="img">
                        <img src="/assets/images/team/atif.png" alt="" loading="lazy" width="" height=""> 
                      </figure>
                    </div>
                    <div class="reference"> <a href="javascript:void(0);" data-url=""> <span class="name">Atif Iqbal</span> <span class="h4">Chief People Officer</span> </a> </div>
                  </div> -->
                  <div class="slide">
                    <div class="slide__inner plane">
                      <figure class="img">
                        <img src="../../www.Dynaverse.net/assets/images/team/seemi.jpg" alt="" loading="lazy" width="" height=""> 
                      </figure>
                    </div>
                    <div class="reference"> <a href="javascript:void(0);" data-url=""> <span class="name">Samreen Munir</span> <span class="h4">President - IT Solutions</span> </a> </div>
                  </div>
                  <div class="slide">
                    <div class="slide__inner plane">
                      <figure class="img">
                        <img src="../../www.Dynaverse.net/assets/images/team/yawer.jpg" alt="" loading="lazy" width="" height=""> 
                      </figure>
                    </div>
                    <div class="reference"> <a href="javascript:void(0);" data-url=""> <span class="name">Yawer Zakaria</span> <span class="h4">Chief Financial Officer</span> </a> </div>
                  </div>
                  <div class="slide">
                    <div class="slide__inner plane">
                      <figure class="img">
                        <img src="../../www.Dynaverse.net/assets/images/team/akbar.jpg" alt="" loading="lazy" width="" height=""> 
                      </figure>
                    </div>
                    <div class="reference"> <a href="javascript:void(0);" data-url=""> <span class="name">Muhammad Akbar Ashraf </span> <span class="h4">Senior Vice President - Sales Operations</span> </a> </div>
                  </div>
                  <div class="slide">
                    <div class="slide__inner plane">
                      <figure class="img">
                        <img src="../../www.Dynaverse.net/assets/images/team/awais.jpg" alt="" loading="lazy" width="" height=""> 
                      </figure>
                    </div>
                    <div class="reference"> <a href="javascript:void(0);" data-url=""> <span class="name">Awais Khan </span> <span class="h4">Chief People & Culture Officer
              ...
              <div class="slider__progress">
                <div class="slider__progress__bar primary"></div>
              </div>
            </div>
          </div>
        </section>
        <section>
          <h5 data-theme="dark" class="caption d-none">&nbsp;</h5>
          <div class="left content sect">
            <h2 class="h2 off anim-text primary extra uppercase mb-4">What matters to us</h2>
            <p class="primary hero off anim-text">Quality matters. That is why the global Dynaverse team ensures the highest standards of quality in everything we produce for our customers. We take pride in being among the top ITes companies in Pakistan.</p>
          </div>
        </section>
        <section id="milestones">
          <h5 data-theme="light" class="caption d-none">&nbsp;</h5>
          <div class="left content sect pb-0 bg-white">
            <h2 class="h2 primary extra uppercase mb-4">MILESTONES</h2>
            <p class="primary hero mb-0 mb-md-5 pb-5">Since the initiation of its operations in 2001, Dynaverse Technologies has excelled in every part of its business. With global operations and an international clientele, we have surpassed all expectations and our entire team takes great pride in where the company stands today - as a leading IT enabled services company in Pakistan with a truly global presence and unparalleled experience in what we do. </p>
            <div class="row-box mb-5 pb-5">
              <div class="row align-items-start justify-content-between">
                <div class="col-md-5">
                <h3 class="h3 primary uppercase mb-4 mb-md-0">In Pakistan, we are the very first company which initiated developing Facebook apps in 2007</h3>
                </div>
                <div class="col-md-6">
                  <p class="primary text ">Two years later (in 2009), we became the pioneer organization in the country to start iOS development. Further, in 2015, another key milestone attained by the company, Dynaverse started business with the United States General Services Administration and secured a contract with NASA.</p>
                </div>
              </div>
            </div>
            <p class="primary hero">In 2021, Dynaverse Technologies became an entity with 1500 employees. The increasing demand for our products and services globally has made it essential for us to increase the number of our workforce. We anticipate that this figure may increase even further in the next few years.</p>
            
          </div>
        </section>
        <section id="locations">
          <h5 data-theme="light" class="caption d-none">&nbsp;</h5>
          <div class="left content sect pt-0 bg-white">
            <div class="map">
              <img src="../assets/images/about/map.png" alt="" class="img-full" loading="lazy" width="" height="">
              <div class="contnt text-center">
              <h2 class="h2 primary extra uppercase mb-4">LOCATIONS</h2>
              <p class="primary text-lg">Being a global company, Dynaverse has a worldwide presence. We are strategically located in three different continents – North America, Europe and Asia. Dynaverse Technologies has offices in the United States, the United Kingdom, the United Arab Emirates and Pakistan. </p>
              </div>
            </div>
          </div>
        </section>
...
<!-- Mirrored from Dynaverse.net/about-us/ by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Aug 2023 22:58:21 GMT -->
</html>